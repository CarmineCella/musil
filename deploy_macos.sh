...
cp src/*.mu src/help.txt src/hrtf_kemar.csv src/hall_concertgebouw.wav "$APP/Contents/Resources/lib/"
cp src/*.mu src/help.txt src/hrtf_kemar.csv src/hall_concertgebouw.wav "$DIST/lib/"
