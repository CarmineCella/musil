...
# pluck.wav: a decaying harmonic tone at 220 Hz, 1.5 s
...
# voice.wav: a vowel-like sound with a slow vibrato, 1.2 s (a formant-filtered pulse train)
...
# drums.wav: four noise bursts with different decays, 1.6 s (for transient/steady separation)
...
# ir.wav: a synthetic stereo room impulse response, 0.5 s of decaying noise with early reflections
var n (* sr 0.5)
