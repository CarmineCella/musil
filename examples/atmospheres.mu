...
# One granulator over the whole piece, the orchestra all ossia players (the band decides the instrument). The
# analysis is not an orchestration of the recording (that is morph_orchestration.mu): the notes are random within
# the band, as in the score they are clusters; only the shape is the recording's.
