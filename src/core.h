...
inline void call_yield() {
    if (g_yield) g_yield ();
}
inline void set_yield(YieldFunction fn) {
    g_yield = fn;
}
...
AtomPtr fn_break (AtomPtr, AtomPtr) {
    return nullptr;    // dummy
}
AtomPtr fn_quote (AtomPtr, AtomPtr) {
    return nullptr;    // dummy
}
AtomPtr fn_def (AtomPtr, AtomPtr) {
    return nullptr;    // dummy
}
AtomPtr fn_set (AtomPtr, AtomPtr) {
    return nullptr;    // dummy
}
AtomPtr fn_lambda (AtomPtr, AtomPtr) {
    return nullptr;    // dummy
}
AtomPtr fn_macro (AtomPtr, AtomPtr) {
    return nullptr;    // dummy
}
AtomPtr fn_if (AtomPtr, AtomPtr) {
    return nullptr;    // dummy
}
AtomPtr fn_while (AtomPtr, AtomPtr) {
    return nullptr;    // dummy
}
AtomPtr fn_begin (AtomPtr, AtomPtr) {
    return nullptr;    // dummy
}
AtomPtr fn_apply (AtomPtr, AtomPtr) {
    return nullptr;    // dummy
}
AtomPtr fn_eval (AtomPtr, AtomPtr) {
    return nullptr;    // dummy
}
